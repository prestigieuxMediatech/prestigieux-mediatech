    ...
    <section className="hero">
      <div className="hero-inner">
        ...
        <p className="hero-sub">
          Performance Marketing · Lead Generation · Content Creation
          <br />
          Web & App Development · Brand Identity — all under one roof.
        </p>
        <div className="hero-actions">
          <button className="btn-primary" onClick={() => typeof window !== 'undefined' && window.openFunnel?.()}>
            <svg width={15} height={15} style={{display: 'inline'}}>
              <use href="#ic-target" />
            </svg>
            Get Free Strategy Session
          </button>
          <button className="btn-ghost" onClick={() => window.navigateTo?.('services')}>
            Explore Services
            <svg width={15} height={15} style={{display: 'inline'}}>
              <use href="#ic-arrow-r" />
            </svg>
